...
def build_dataloaders(cfg):
    ...
    train_ds = RetrievalJsonDataset(dcfg['annotation_json'], dcfg['images_root'], dcfg['train_split'], transform)
    val_ds = RetrievalJsonDataset(dcfg['annotation_json'], dcfg['images_root'], dcfg['val_split'], transform)
    test_ds = RetrievalJsonDataset(dcfg['annotation_json'], dcfg['images_root'], dcfg['test_split'], transform)
    kwargs = dict(
